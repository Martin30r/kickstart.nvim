...
-- Setup expand tab, tab stop, and shiftwidth instead of tabs
-- NOTE: 'modeline' removed from end of file on this topic.
...
require('lazy').setup({
    ...
    -- NOTE: The following are the plugins that I've added to this config myself.
